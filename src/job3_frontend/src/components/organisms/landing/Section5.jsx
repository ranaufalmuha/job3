...
export const Section5 = () => {
    return (
        <section className='px-8 py-24 flex justify-center duration-300'>
            <div className="container duration-300 flex flex-col gap-8 max-lg:gap-4 bg-headlines text-white rounded-xl px-14 py-28 relative overflow-hidden justify-center">
                ...
                <img src="/images/landing1.webp" className='top-0 left-0 absolute object-cover opacity-50 w-full h-full' alt="" />
            </div>
        </section>
    )
}
